              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      width: 1.5,
                      color: const Color.fromRGBO(94, 112, 229, 1),
                    ),
                  ),
                  child: Center(
                    child: Obx(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: const Color.fromRGBO(94, 112, 229, 1), width: 1.5),
                ),
                  ...
                  onPressed: () {
                    setState(() {
                      ...
                      tempIndex = tempIndex == dropBlock.length - 1
                          ? tempIndex
                          : tempIndex + 1;
                      _selectedBlock = getBlock.elementAt(tempIndex).sBlock_CD;
                      get_BayInfo(sCorp_CD, shareWC, _selectedBlock);
                      get_BlockBayContrMove(
                          sCorp_CD, shareWC, _selectedBlock, _selectedBay);
                    });
        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            leading: IconButton(
              ...
              onPressed: () => _scaffoldKey3.currentState?.openDrawer(),
            ),
          ),
        ),
        drawer: Drawer(
...
class CCustomSearchDelegate extends SearchDelegate {
  // # Api 관련 변수
