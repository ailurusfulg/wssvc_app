...
class APIGetPartnerInfo {
  var url = Uri.parse('https://easycontainer.kuls.co.kr/ext/Ezcon_BNP/GetPartnerInfo.php');
  ...
  Future getSelect(String sFunctionName, List<String> sParam) async {
    ...
    switch (sFunctionName) {
      case "USP_GET_PARTNER_INFO":
        final response = await http.post(url, body: sBody, headers: headers);
        result = PartnerResultModel.fromJson(json.decode(response.body));
        break;
    }
    return result;
  }
