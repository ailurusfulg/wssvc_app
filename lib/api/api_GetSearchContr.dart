...
class APIGetSearchContr {
  var url = Uri.parse('https://easycontainer.kuls.co.kr/ext/Ezcon_BNP/GetSearchContr.php');
  ...
  Future getSelect(String sFunctionName, List<String> sParam) async {
    ...
    switch (sFunctionName) {
      case "USP_GET_CONTR_SEARCH":
        final response = await http.post(url, body: sBody, headers: headers);
        result = SearchContrResultModel.fromJson(json.decode(response.body));
        break;
    }
    return result;
  }
