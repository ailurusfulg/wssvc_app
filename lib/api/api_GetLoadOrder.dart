...
class APIGetLoadOrder {
  var url = Uri.parse('https://easycontainer.kuls.co.kr/ext/Ezcon_BNP/GetLoadOrder.php');
  ...
  Future getSelect(String sFunctionName, List<String> sParam) async {
    ...
    switch (sFunctionName) {
      case "USP_GET_LOADORDER":
        final response = await http.post(url, body: sBody, headers: headers);
        result = LoadResultModel.fromJson(json.decode(response.body));
        break;
    }
    return result;
  }
