...
class Localization extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'kr': {
          ...
          'auth.resetPasswordButton': '비밀번호 초기화',
          'auth.emailFormField': '이메일',
          'auth.passwordFormField': '비밀번호',
          'auth.nameFormField': '이름',
          'auth.signInErrorTitle': '로그인 에러',
          'auth.signInError': '로그인 실패: 잘못된 이메일 혹은 비밀번호입니다.',
          'auth.resetPasswordLabelButton': '비밀번호를 잊어버리셨습니까?',
          'auth.signUpLabelButton': '계정 등록',
          'auth.signUpErrorTitle': '계정 등록 실패',
          'auth.signUpError': '계정 등록에 문제가 있습니다. 잠시 후 시도해주세요.',
          ...
          'auth.resetPasswordFailed': '비밀번호를 초기화하는데 실패하였습니다.',
          'auth.signInonResetPasswordLabelButton': '로그인',
          'auth.updateUser': 'Update Profile',
          'auth.updateUserSuccessNoticeTitle': 'User Updated',
          'auth.updateUserSuccessNotice': '사용자 정보가 성공적으로 저장되었습니다.',
          'auth.updateUserEmailInUse': '해당 이메일은 이미 등록되어 있습니다.',
          'auth.updateUserFailNotice': 'Failed to update user',
          'auth.enterPassword': '비밀번호를 입력해주세요.',
          'auth.cancel': '취소',
          'auth.submit': '제출',
          ...
          'home.uidLabel': '계정',
          'home.emailLabel': '이메일',
          'home.adminUserLabel': '관리자 계정',
          'app.title': 'Flutter Starter Project',
          'validator.email': '이메일 주소를 입력해주세요.',
          'validator.password': '비밀번호는 6자리 이상이어야합니다.',
          'validator.name': '이름을 기입해주세요.',
          'validator.number': '숫자를 입력해주세요.',
